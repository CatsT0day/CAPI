...
public class fly extends CAPICommandTemplate {

    public fly(CAPI plugin) {
        super(plugin, "fly", List.of("flight"), CAPIPermissionManager.CAPIPerm.FLY, true, 0, "Set flight mode for players");
    }
    ...
    private boolean execute(CommandSender sender, String[] args) {
        ...
        CAPIUser user = plugin.getUser(target);
