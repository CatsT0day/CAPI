...
import me.catst0day.capi.Managers.Perms.LuckPermsHandler5;
...
public class CAPIPermissionManager {
    ...
    public boolean hasPermission(Player player, CAPIPerm permission, String... args) {
    ...
    public enum CAPIPerm {
        ...
        CAPIPerm(String permission, String description) {
